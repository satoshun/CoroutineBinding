 ...
 */
@CheckResult
fun ViewPager.pageScrollStateChanges(capacity: Int = 0): ReceiveChannel<Int> = cancelableChannel2(capacity) {
 ...
 */
@CheckResult
fun ViewPager.pageSelections(capacity: Int = 0): ReceiveChannel<Int> = cancelableChannel2(capacity) {
  val listener = object : ViewPager.OnPageChangeListener {
    override fun onPageScrollStateChanged(state: Int) {
    }
